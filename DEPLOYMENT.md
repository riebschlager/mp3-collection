...
The repository deploys the Astro site in `apps/web/` to GitHub Pages using GitHub Actions.
...
- Runs `npm ci` and `npm run build` in `apps/web/`
...
3. GitHub Actions builds and deploys `apps/web/dist`.
